...
function setupPuzzle(){
	...
	for(var i=0; i < puzzleCells.length; i++){
		...
		//set the cellbackground color in response to the mousedown event
	...
	//create objects collections of the filled and empty cells
		...
		function(){
			...
			setTimeout(
			function(){
				//change pink cells to white and red cells
				for(var i=0; i < puzzleCells.length;i++){
